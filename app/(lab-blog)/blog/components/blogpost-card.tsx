			...
			return (
				<Link
					...
					className={clsx(
						...
						'border-border bg-surface-secondary text-text-secondary dark:border-dark-border dark:bg-dark-surface-secondary dark:text-dark-text-secondary dark:hover:shadow-grayscale-700 hover:shadow-md dark:hover:shadow',
