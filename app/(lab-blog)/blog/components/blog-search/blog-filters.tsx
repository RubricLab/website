		...
		<div className='sticky top-header z-20 bg-surface'>
			<label
				...
				<input
					...
					className='grow bg-transparent max-md:text-[max(1em,16px)] uppercase outline-0 placeholder:uppercase placeholder:text-text-tertiary focus-visible:outline-none'
					placeholder='Search'
					type='text'
					ref={searchInputRef}
				/>
