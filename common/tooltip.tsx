	...
	return (
		<Tooltip.Root>
			...
			<Tooltip.Portal>
				<Tooltip.Content
					className={clsx(
						'z-[999] max-w-em-[200] border border-border bg-surface-secondary px-2 py-1 text-sm text-text',
						className
					)}
...
function Arrow() {
	return (
		...
		>
			...
			<path className="fill-surface-secondary stroke-border" d="M6 7.5L0.5 0.5H11.5L6 7.5Z" />
			<path className="fill-surface-secondary" d="M1 0H11L10.5 1H1.5L1 0Z" />
		</svg>
	)
}
