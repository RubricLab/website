	...
	return (
		<Tooltip.Root>
			...
			<Tooltip.Portal>
				<Tooltip.Content
					className={clsx(
						'border-border bg-surface-secondary text-text-secondary dark:border-dark-border dark:bg-dark-surface-secondary dark:text-dark-text-secondary z-[999] max-w-[160px] rounded-md border px-2 py-1 text-sm',
						className
					)}
					{...props}>
					{content}
