...
export class WebAudioPlayer {
	...
	constructor() {
		// @ts-ignore
		this.audioContext = new // biome-ignore lint/suspicious/noExplicitAny: <explanation>
...
export const useAudio = create<AudioStore>((set, get): any => {
	const player = typeof window !== 'undefined' ? new WebAudioPlayer() : undefined
