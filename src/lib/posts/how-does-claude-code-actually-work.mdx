...
<Figure id="phases">
  <AgentLoopCards />
  <Figure.Caption>The phases Claude Code cycles through</Figure.Caption>
</Figure>
...
<Figure id="system-architecture">
  <SystemArchitecture />
  <Figure.Caption>The context window grows as Claude gathers, acts, and verifies.</Figure.Caption>
</Figure>
