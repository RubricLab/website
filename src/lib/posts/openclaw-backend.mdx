...
import { OpenclawSmsAgentFigure } from '~/ui/blog/openclaw-backend'

export const metadata = {
  title: "Every Server Deserves a Coding Agent",
  subtitle: "The promise and peril of collocating code and coding agent",
  date: "2026-05-01",
  isNew: true,
  author: AUTHORS.TED_SPARE,
  category: CATEGORIES.EXPERIMENT,
  description: "The promise and peril of collocating code and coding agent",
...
<Figure id="openclaw-system">
  <OpenclawSmsAgentFigure />
  <Figure.Caption>The user sees a text thread. The agent does the rest.</Figure.Caption>
</Figure>
