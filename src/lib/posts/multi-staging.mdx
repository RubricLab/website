...
export const metadata = {
  ...
  bannerImageUrl: "/images/highway.png",
  category: "DevOps",
...
As always, this is a work in progress. Please send feedback or questions to <Copiable content="hello@rubriclabs.com" variant="link" size="lg">hello@rubriclabs.com</Copiable>.
