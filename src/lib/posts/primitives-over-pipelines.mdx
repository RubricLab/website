...
import { AssemblyScenariosFigure, PipelinePrimitivesFigure } from '~/ui/blog/primitives-over-pipelines'
...
<Figure id="assembly-scenarios-figure">
  <AssemblyScenariosFigure />
  <Figure.Caption>The same primitives can assemble different workflows at runtime.</Figure.Caption>
</Figure>
...
> **Actionable insight:** "Don't try to anticipate every path. Give primitives and let the agent figure it out."
