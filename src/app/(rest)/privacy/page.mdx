...
<p className='text-sm'>Last Updated: {formatDate(new Date('2025-03-27').toISOString())}</p>
...
us through our contact form or email us at <Copiable message="Email copied" variant="link" size="lg" className="text-secondary" content="hello@rubriclabs.com">hello@rubriclabs.com</Copiable>.
