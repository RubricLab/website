...
export const metadata = createMetadata({
	description: `The Grid is a newsletter by Rubric Labs with three actionable insights on building, shipping, and scaling intelligent products. ${META.description}`,
	pathname: '/newsletter',
