...
// multi-step flow with local state. Iteration 1 is deliberately frictional
// (too many fields, dead-ends, no skip); iteration 3 is smooth. Each column
  ...
  return (
    <DemoSection
      ...
      columns={[
        ...
        {
          body: <Replayable>{() => <FlowV1 />}</Replayable>,
          caption: "better",
          label: "Iteration 2",
        },
        {
          body: <Replayable>{() => <FlowV2 />}</Replayable>,
          caption: "smooth",
          label: "Iteration 3",
        },
      ]}
