...
var ClientPump = ({
  ...
  React.useEffect(() => {
    if (currentToastRef.current) {
      ue.dismiss(currentToastRef.current);
    }
    if (!result?.errors)
      return;
    ...
    if (!mainError)
      return;
    currentToastRef.current = ue.error(
  ...
  React.useEffect(() => {
    ...
    if (!pusherAppKey || !pusherCluster)
      return;
    pusherMounted = true;
    import("./pusher-GDERSANY.js").then((mod) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, resolvedChildren ?? initialResolvedChildren, /* @__PURE__ */ React.createElement($e, { closeButton: true }));
};
