						...
						<div className="flex h-full flex-col gap-8 text-black sm:gap-16 dark:text-white">
							<div className="flex flex-col gap-8 sm:gap-0">
								...
								<p className="text-4xl tracking-tight sm:text-8xl sm:leading-[7.5rem]">
									We make magical, <span className="whitespace-nowrap">AI-first</span> software.
								</p>
							</div>

							<p className="max-w-xl text-2xl text-secondary sm:leading-10">
								We are an applied AI lab working with companies to build the future users want.
							</p>

							<p className="invisible text-tertiary sm:visible">
								Press{' '}
